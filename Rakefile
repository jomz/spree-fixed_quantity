...
desc 'Generate documentation for the fixed_quantity extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'FixedQuantityExtension'
...
desc 'Test the fixed_quantity extension.'
...
namespace :test do
  desc 'Functional test the fixed_quantity extension.'
  ...
  desc 'Unit test the fixed_quantity extension.'
