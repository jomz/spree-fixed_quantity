class FixedQuantityHooks < Spree::ThemeSupport::HookListener
  insert_after :admin_product_form_right, 'admin/products/base_quantity_field'
  replace :inside_product_cart_form, 'products/product_cart_form_with_quantity_dropdown'
  replace :cart_item_quantity, 'orders/cart_item_quantity'
  #
